...
export interface MealImportConfirmationOptions {
  date: string;
  historical: boolean;
  replacing: boolean;
...
export function confirmMealImport(
  app: App,
  options: MealImportConfirmationOptions,
): Promise<boolean> {
...
class MealImportConfirmationModal extends Modal {
  private resolved = false;

  constructor(
    app: App,
    private options: MealImportConfirmationOptions,
