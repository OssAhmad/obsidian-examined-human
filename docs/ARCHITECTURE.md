...
- `migrations/001_upgrade_v5_to_schema_v1.sql` and `migrations/002_add_finance_foundation_schema_v1.sql` — the additive pre-1.0 upgrade path from the retired v5 database into the current official Schema v1.
